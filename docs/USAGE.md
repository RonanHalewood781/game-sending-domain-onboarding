...
The single thin client is the seam: add a method that calls another `/v1/...` route (e.g. one of email.domain.verify, email.domain.get) and reuse it from your own code.
